...
let realOutputResult =  divContainer.querySelector('.real-result .inner-result');
...
document.addEventListener('click',(e)=>{
    ...
    if(e.target.className == "but"){
        ...
        if(resultArea.innerHTML =='please insert a number'){
    ...
    if(e.target.className == "btn-CON"){
        //remove or delete one number if you want to do that when you put wrong number...slice=>extract number or string
    ...
    if(e.target.className == "btn-equal"){
        if(resultArea.innerHTML == ''){
            resultArea.innerHTML = 'please insert a number'
        }else{
            //evaluate expression 
            realOutputResult.textContent =  eval(resultArea.innerHTML);
           resultArea.innerHTML = ''
        }
